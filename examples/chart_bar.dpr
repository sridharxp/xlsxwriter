...
begin
  ReportName := '.\Report\chart_bar.xlsx';
  ...
  worksheet := workbook_add_worksheet(workbook, nil);
     ...
     *)
    chart := workbook_add_chart(workbook, Byte(LXW_CHART_BAR_STACKED));
     ...
     *)
    chart := workbook_add_chart(workbook, Byte(LXW_CHART_BAR_STACKED_PERCENT));
